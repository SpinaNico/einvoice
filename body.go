...
type datiGeneraliDocumento struct {
	...
	ImportoTotaleDocumento string                 `xml:"ImportoTotaleDocumento" json:"ImportoTotaleDocumento" validate:"isPrice,max=15,min=4"`
	Arrotondamento         string                 `xml:"Arrotondamento" json:"Arrotondamento" validate:"isPrice,max=15,min=4"`
	Causale                []string               `xml:"Causale" json:"Causale"`
	Art73                  string                 `xml:"Art73" json:"Art73" validate:"eq=SI"`
}
...
type datiRiepilogo struct {
	...
	Natura            string  `xml:"Natura" json:"Natura" validate:"isNatura"`
	Detraibile        string  `xml:"Detraibile" json:"Detraibile" validate:"isPrice,min=4,max=6"`
	Deducibile        string  `xml:"Deducibile" json:"Deducibile" validate:"eq=SI"`
	EsigibilitaIVA    string  `xml:"EsigibilitaIVA" json:"EsigibilitaIVA" validate:"oneof=I D S"`
}
...
type datiTrasporto struct {
	...
	PesoLordo             string                `xml:"PesoLordo" json:"PesoLordo" validate:"isPrice,min=4,max=7"`
	PesoNetto             string                `xml:"PesoNetto" json:"PesoNetto" validate:"isPrice,min=4,max=7"`
	DataOraRitiro         string                `xml:"DataOraRitiro" json:"DataOraRitiro" validate:"isDateTime"`
	DataInizioTrasporto   string                `xml:"DataInizioTrasporto" json:"DataInizioTrasporto" validate:"isDate"`
	TipoResa              string                `xml:"TipoResa" json:"TipoResa" validate:"len=3,oneof=EXW FCA CPT CIP DAT DAP DDP FAS FOB CFR CIF"`
...
type dettaglioLinee struct {
	...
	Ritenuta                   string              `xml:"Ritenuta" json:"Ritenuta" validate:"eq=SI"`
	Natura                     string              `xml:"Natura" json:"Natura" validate:"isNatura"`
	RiferimentoAmministrazione string              `xml:"RiferimentoAmministrazione" json:"RiferimentoAmministrazione" validate:"max=20"`
...
type dettaglioPagamento struct {
	...
	DataRiferimentoTerminiPagamento string `xml:"DataRiferimentoTerminiPagamento" json:"DataRiferimentoTerminiPagamento" validate:"isDate"`
	GiorniTerminiPagamento          int    `xml:"GiorniTerminiPagamento" json:"GiorniTerminiPagamento" validate:"min=0,max=999"`
	DataScadenzaPagamento           string `xml:"DataScadenzaPagamento" json:"DataScadenzaPagamento" validate:"isDate"`
	ImportoPagamento                string `xml:"ImportoPagamento" json:"ImportoPagamento" validate:"isPrice,min=4,max=15"`
	CodUfficioPostale               string `xml:"CodUfficioPostale" json:"CodUfficioPostale" validate:"max=20"`
	CFQuietanzante                  string `xml:"CFQuietanzante" json:"CFQuietanzante" validate:"max=16"`
	NomeQuietanzante                string `xml:"NomeQuietanzante" json:"NomeQuietanzante" validate:"max=60"`
	CognomeQuietanzante             string `xml:"CognomeQuietanzante" json:"CognomeQuietanzante" validate:"max=60"`
	TitoloQuietanzante              string `xml:"TitoloQuietanzante" json:"TitoloQuietanzante" validate:"max=10,min=2"`
	IstitutoFinanziario             string `xml:"IstitutoFinanziario" json:"IstitutoFinanziario" validate:"max=80"`
	IBAN                            string `xml:"IBAN" json:"IBAN" validate:"min=15,max=34"`
	ABI                             int    `xml:"ABI" json:"ABI" validate:"len=5"`
	CAB                             string `xml:"CAB" json:"CAB" validate:"len=5"`
	BIC                             string `xml:"BIC" json:"BIC" validate:"min=8,max=11"`
	ScontoPagamentoAnticipato       string `xml:"ScontoPagamentoAnticipato" json:"ScontoPagamentoAnticipato" validate:"isPrice,min=4,max=15"`
	DataLimitePagamentoAnticipato   string `xml:"DataLimitePagamentoAnticipato" json:"DataLimitePagamentoAnticipato" validate:"isDate"`
	PenalitaPagamentiRitardati      string `xml:"PenalitaPagamentiRitardati" json:"PenalitaPagamentiRitardati" validate:"isPrice,min=4,max=15"`
	DataDecorrenzaPenale            string `xml:"DataDecorrenzaPenale" json:"DataDecorrenzaPenale" validate:"isDate"`
